...
var onLoad =  $(document).ajaxStop(function () {
    ...
    var long = tokyo.responseXML.children[0].children[i].getElementsByTagName("Longitude")[0].innerHTML
    var lat = tokyo.responseXML.children[0].children[i].getElementsByTagName("Latitude")[0].innerHTML
