...
var onLoad =  $(document).ajaxStop(function () {
    ...
    var long = parseFloat(tokyo.responseXML.children[0].children[i].getElementsByTagName("Longitude")[0].innerHTML)
    var lat = parseFloat(tokyo.responseXML.children[0].children[i].getElementsByTagName("Latitude")[0].innerHTML)
